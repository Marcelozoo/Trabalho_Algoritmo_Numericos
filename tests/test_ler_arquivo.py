...
def test_ler_arquivo():
    ...
    Caso de teste do src/arquivos/arq.txt e do src/arquivos/arq2.txt

    """
    caminho_arquivo = "arquivos/arq.txt"
    quantidade_sistemas, ordem_da_matriz, precisao, matriz_A, vetores_b = ler_arquivo(
        caminho_arquivo
    )
    ...
    assert np.array_equal(
        matriz_A, np.array([[5.0, 2.0, 1.0], [2.0, -1.0, 3.0], [0.0, 1.0, -2.0]])
    )
    assert np.array_equal(vetores_b, [np.array([8.0, 9.0, -6.0])])

    caminho_arq2 = "arquivos/arq2.txt"
    quantidade_sistemas, ordem_da_matriz, precisao, matriz_A, vetores_b = ler_arquivo(
        caminho_arq2
    )
    ...
    assert np.array_equal(vetores_b, [np.array([[6.0, -5.0, 3.0], [6.0, 7.0, -8.0]])])
